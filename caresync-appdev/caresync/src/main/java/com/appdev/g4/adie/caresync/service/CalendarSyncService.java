...
public class CalendarSyncService {
    ...
    public CalendarSync updateCalendarSync(Long id, CalendarSync calendarSyncDetails) {
        ...
        if (calendarSync != null) {
            ...
            calendarSync.setEventDate(calendarSyncDetails.getEventDate());
            calendarSync.setStartTimeYear(calendarSyncDetails.getStartTimeYear());
            calendarSync.setStartTimeMonth(calendarSyncDetails.getStartTimeMonth());
            return calendarSyncRepository.save(calendarSync);
        }
        return null;
    }
